...
selected text straight into your Machina AI knowledge brain. It's a **thin client** — it
...
1. Right-click the toolbar icon → **Machina AI settings…** (or click the icon before a
   token is set — it opens settings automatically).
2. Paste your **ingest token**. Get it from the Machina AI app → Settings (it's the same
...
| **Right-click a link** → Save to Machina AI | the link's URL (not the page) |
| **Select text** → right-click → Save to Machina AI | the page URL, with the selection saved as the note/body |
| **Right-click the page** → Save to Machina AI | the current tab's URL |
...
*"Saved to Machina AI ✓ — &lt;page title&gt; — analyzing now, it'll appear in your app
shortly."*, *"Already in Machina AI"*, or a clear error. The card then appears in the
