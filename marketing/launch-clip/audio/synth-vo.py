...
LINES = [
    ...
    (2.45, 0.8, "Every app keeps its own pile."),
    (3.25, 1.75, "Then you need one thing back — and you have no idea where it went."),
    (5.5, 1.1, f"So {SAY_NAME} keeps it all in one place."),
    (7.35, 1.25, "One tap, and it's saved — without leaving the app."),
    (8.95, 2.4, f"{SAY_NAME} reads it, summarizes it, and files it."),
    (12.3, 2.0, "Save from any app. Find it without remembering where."),
    (14.3, 0.8, f"{SAY_NAME} finds the one you meant."),
    (15.35, 1.6, f"Then ask {SAY_NAME} anything."),
    (17.4, 1.9, "Answers from your saves — and nothing else."),
    (20.4, 2.3, f"Two saves, months apart — {SAY_NAME} notices they belong together."),
