    ...
    return (
        <div className="fixed inset-0 z-[90] flex items-end sm:items-center justify-center animate-fade-in">
            ...
            <div
                ...
                className="relative w-full sm:max-w-sm bg-card border-t sm:border border-white-fixed/10 rounded-t-3xl sm:rounded-3xl shadow-2xl animate-slide-up overflow-hidden safe-pb"
            >
                ...
                <div className="py-1">
                    {rows.map((row) => (
                        <button
                            ...
                            className={`w-full flex items-center gap-4 px-5 py-3.5 min-h-[52px] text-[15px] font-medium transition-colors active:bg-white-fixed/10 ${
                                row.danger
                                    ? 'text-red-400 hover:bg-red-500/10'
                                    : row.active
                                        ? 'text-accent hover:bg-accent/10'
                                        : 'text-text hover:bg-white-fixed/5'
                            }`}
                        >
