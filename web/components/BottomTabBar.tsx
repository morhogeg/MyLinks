 ...
 * mobile FAB), Ask, and Revisit.
 *
 * The Revisit tab's key stays `'digest'`: it is the id in the push payload
...
export default function BottomTabBar({
    ...
    const tabs: { key: BottomTab; label: string; icon: React.ReactNode; tour?: string }[] = [
        ...
        { key: 'digest', label: 'Revisit', icon: <CalendarCheck className="w-[20px] h-[20px]" /> },
    ];
        ...
        >
            ...
            <div className="flex items-center justify-around h-[50px] px-1">
                ...
                {/* Center capture — the app's core act. CONTAINED within the bar
                    ...
                    got clipped by the full-screen Collections/Revisit overlays and
