                ...
                <article className="max-w-[44rem] mx-auto px-5 sm:px-8 py-8 sm:py-12 safe-pb" style={{ fontSize }}>
                    {loading ? (
                        ...
                        <div className="text-center py-16">
                            ...
                            {isHttpUrl(link.url) && (
                                <a href={link.url} target="_blank" rel="noopener noreferrer" className="inline-flex items-center gap-2 px-4 py-2 rounded-xl bg-accent text-accent-ink text-sm font-semibold hover:bg-accent-hover transition-colors">
