...
function Toast({ item, onDismiss }: { item: ToastItem; onDismiss: () => void }) {
    ...
    return (
        <div className="pointer-events-auto w-full flex items-start gap-3 bg-card border border-white-fixed/10 rounded-xl px-4 py-3 shadow-2xl backdrop-blur-lg animate-slide-up">
