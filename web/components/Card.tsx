                ...
                <div className="p-4 sm:p-5 flex flex-col h-full space-y-3">
                    ...
                    {failed ? (
                        <p className="text-sm text-text-secondary flex-grow">
                            Your link is safe. The AI analysis didn’t finish; retry, or open the original.
                        </p>
                    ) : (
    ...
    return (
        ...
        >
            ...
            <div
                ...
                dir={isRtl ? "rtl" : "ltr"}
            >
                {/* Header Row: Category (left) and Source + ⋯ (right) — pinned
                    LTR for EVERY card. This row is chrome, not content: controls
                    live in one stable place app-wide (a mixed EN/HE feed had the
